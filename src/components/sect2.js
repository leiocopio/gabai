...
function sect2() {
  return (
    <div
      className="
      h-screen
      flex flex-row justify-around items-center mx-10
      max-md:flex-col
      "
    >
      ...
      <div className="px-10 max-md:hidden">{/* Just to give them space*/}</div>
      <div className="p-0">
        <h1 className="text-6xl font-bold mb-4 max-md:text-center">
          About <span className="text-azure">GabAi</span>
        </h1>
        <p className="text-justify text-2xl max-md:text-center">
