    ...
    <div className="bg-gray-100 h-screen">
      <div className="p-4">
        ...
        <div className="flex justify-between items-center mt-4">
          <p className="text-xl text-gray-600">List Of Feedbacks <span className="text-blue-500">{FeedBacks.length}</span></p>
      ...
      <div className="bg-gray-200 p-4">
        <div className=" border border-sky-800 overflow-x-auto">
          <table className="w-full table-auto">
            ...
            <tbody>
              {FeedBacks.map((cases) => (
                <tr key={FeedBacks.id} className="border-b last:border-b-0 border-gray-200">
